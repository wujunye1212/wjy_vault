...
第三步
```
python add_color_main.py --data_path "D:/project/neuro-3d/EEGdata/" --generation_type color --in_channel 1033 --sub sub01 --max_steps 40000 --checkpoint_freq 5000 --pretrain_model "retri_color_shape_12-23_16-56_VideoImageEEGClassifyColor3_color_video_fea_time_len1" --num_workers 0
```
# 小技巧随记
